...
import com.example.userbinkitclone.databinding.ItemViewBestaellerBinding
...
class AdapterBestseller(val onSeeAllButtonClicked:(Bestseller)->Unit) :RecyclerView.Adapter<AdapterBestseller.BestsellerViewHolder>() {
    ...
    class BestsellerViewHolder(val binding: ItemViewBestaellerBinding): ViewHolder(binding.root)
...
return BestsellerViewHolder(ItemViewBestaellerBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
